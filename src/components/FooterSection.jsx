...
export const FooterSection = () => {
  ...
  return (
    <footer className="relative py-20 overflow-hidden bg-gray-900 dark:bg-dark-primary">
      {/* Background gradient */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute inset-0 bg-gradient-to-b from-violet-900/20 to-transparent" />
        <div className="absolute -inset-x-40 -top-40 h-[500px] bg-gradient-conic opacity-20 blur-3xl" />
      </div>
            ...
            >
              {socialLinks.map((link) => (
                <a
                  key={link.name}
                  href={link.url}
                  className="p-2 text-gray-400 transition-colors duration-200 rounded-xl hover:bg-violet-900/30 hover:text-violet-400"
                  target="_blank"
